class AllBinsListInObj {
  String? status;
  int? totalDustbins;
  List<Dustbins>? dustbins;

  AllBinsListInObj({this.status, this.totalDustbins, this.dustbins});

  AllBinsListInObj.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    totalDustbins = json['total_dustbins'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['total_dustbins'] = this.totalDustbins;
