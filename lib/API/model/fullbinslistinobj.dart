class FullBinsListInObj {
  String? status;
  int? totalFullDustbins;
  List<Dustbins>? dustbins;

  FullBinsListInObj({this.status, this.totalFullDustbins, this.dustbins});

  FullBinsListInObj.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    totalFullDustbins = json['total_full_dustbins'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['total_full_dustbins'] = this.totalFullDustbins;
