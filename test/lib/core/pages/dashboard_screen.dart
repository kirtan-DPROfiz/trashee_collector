...
import 'package:flutter/material.dart';
import 'package:trashee_collector/core/pages/map_screen.dart';
import 'package:trashee_collector/core/pages/statistics_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildOverviewCard("Total Bins", totalBins, Colors.blue, Icons.delete),
                _buildOverviewCard("Full Bins", fullBins, Colors.red, Icons.warning),
              ],
            ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                _buildOverviewCard("Empty Bins", emptyBins, Colors.green, Icons.check_circle),
                _buildOverviewCard("Half-Full", halfBins, Colors.orange, Icons.hourglass_bottom),
              ],
            ),
  ...
  Widget _buildQuickAccessTile(String title, IconData icon, VoidCallback onTap) {
    return Card(
      elevation: 2,
          ...
          DrawerHeader(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 8),
                Text("Navigate through the app", style: TextStyle(color: Colors.white70)),
              ],
            ),
          ),
          ListTile(
